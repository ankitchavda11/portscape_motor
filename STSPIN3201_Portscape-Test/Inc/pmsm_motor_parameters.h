...
#define RS                     0.36 /* Stator resistance , ohm*/
...
#define NOMINAL_CURRENT         6682
#define MOTOR_MAX_SPEED_RPM     49000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  0.5 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -6682 /*!< Demagnetization current */
